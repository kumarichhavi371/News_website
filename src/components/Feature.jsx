    ...
    <div>
      ...
      <div class="max-w-screen-xl mx-auto">
        <div class="max-w-3xl mx-auto mb-16 text-center">
          <h2 class="text-white text-3xl lg:text-4xl font-bold text-center mb-4 leading-relaxed">Discover Our Exclusive Features</h2>
          <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Unlock a world of possibilities with our exclusive features. Explore how our unique offerings can transform your journey and empower you to achieve more.</p>
        </div>
        <div class="grid lg:grid-cols-3 md:grid-cols-2 mx-auto">
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-lg font-semibold mb-3">Customization</h3>
            <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Easily tailor every aspect of the platform to suit your business needs. From design tweaks to functional preferences and operate.</p>
          </div>
          ...
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Your privacy is our top priority. We implement industry-standard encryption and real-time threat detection to keep your data safe.</p>
          </div>
          ...
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Our expert support team is available around the clock to assist you. we’re here to ensure your experience remains smooth.</p>
          </div>
          ...
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Experience lightning-fast load times and seamless performance. Our system is built to deliver results without lag or disruption.</p>
          </div>
          ...
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-lg font-semibold mb-3">Global Reach</h3>
            <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Whether you're a startup or enterprise. Add users, features, or capabilities without disrupting performance.</p>
          </div>
          ...
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Tailor our product to suit your needs Seamless communication for your team.</p>
          </div>
        </div>
      </div>
    </div>
