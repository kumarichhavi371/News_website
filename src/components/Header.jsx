          ...
          <ul
            ...
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'>
              <NavLink to={"/"} href='javascript:void(0)'
                class='font-medium lg:hover:text-blue-700 text-blue-700 block text-[15px]'>Home</NavLink>
            </li>
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'><NavLink to={"/team"} href='javascript:void(0)'
              class='font-medium lg:hover:text-blue-700 text-slate-900 block text-[15px]'>Team</NavLink>
            </li>
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'><NavLink to={"/feature"} href='javascript:void(0)'
              class='font-medium lg:hover:text-blue-700 text-slate-900 block text-[15px]'>Feature</NavLink>
            </li>
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'><NavLink to={"/blog"} href='javascript:void(0)'
              class='font-medium lg:hover:text-blue-700 text-slate-900 block text-[15px]'>Blog</NavLink>
            </li>
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'><NavLink  to={"/about"} href='javascript:void(0)'
              class='font-medium lg:hover:text-blue-700 text-slate-900 block text-[15px]'>About</NavLink>
            </li>
          </ul>
        </div>
